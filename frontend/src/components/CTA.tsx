    ...
    <section className="relative min-h-screen bg-base flex flex-col items-center justify-center py-24 overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-4 flex flex-col items-center">
        ...
        <a
          ...
          className="bg-amber-500 text-base font-mono font-bold uppercase tracking-widest px-8 sm:px-12 py-4 sm:py-6 rounded-none hover:bg-amber-400 active:bg-amber-600 transition-colors duration-300 mb-12 sm:mb-16 relative overflow-hidden group inline-block"
        >
          <span className="relative z-10">Start Enforcing</span>
          <div className="absolute inset-0 bg-white/20 translate-y-full group-hover:translate-y-0 transition-transform duration-300 ease-out" />
        </a>

        <p className="font-mono text-xs sm:text-sm md:text-base text-gray-500 tracking-widest uppercase">
